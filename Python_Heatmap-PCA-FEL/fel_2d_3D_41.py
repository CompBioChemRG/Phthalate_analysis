...
ax.set_xlabel('PC1', fontsize=28, labelpad=20)
ax.set_ylabel('PC2', fontsize=28, labelpad=20)
ax.set_zlabel('', fontsize=20, labelpad=0)
...
cbar = fig.colorbar(mappable, ax=ax, shrink=0.5, aspect=15, pad=0)
cbar.set_label('FEL (kcal/mol)',fontsize=28, labelpad=25)
